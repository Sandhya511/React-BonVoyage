...
export default class Choice extends Component {
  buttonstyle={marginRight:'10px',marginBottom:'10px',padding:'0px',borderColor:'#0480AB',color:'#770343'}
  render() {
    return (
          ...
          <Paper variant='outlined' style={{width:'1200px',height:'710px', borderRadius:'20px' ,opacity:'0.7'}}>
            ...
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography>
                  <Link to='../Whatsnext'>
                <Button variant="text" sx={this.buttonstyle}>KERALA</Button>
                </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography>
                <Link to='../Whatsnext'>
                <Button variant="text" sx={this.buttonstyle}>HYDERABAD</Button>
                </Link>
                </Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography>
                <Link to='../Whatsnext'>
                <Button variant="text" sx={this.buttonstyle}>SHIMLA</Button>
                </Link>
                </Typography>
              </div>
            </div>
            <div style={{display: 'flex',
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography>
                <Link to='../Whatsnext'>
                <Button variant="text" sx={this.buttonstyle}>DELHI</Button>
                </Link>
                </Typography>
              ...
              <div style={{flex: '10%', padding: '0 4px'}}>
                ...
                <Typography>
                <Link to='../Whatsnext'>
                <Button variant="text" sx={this.buttonstyle}>KASHMIR</Button>
                </Link>
                </Typography>
                {/* <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><h2>KASHMIR</h2></Typography> */}
              </div>
            </div>
          </Paper>
        </Grid>

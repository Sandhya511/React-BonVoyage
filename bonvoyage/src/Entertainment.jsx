                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="Mall"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Button variant='contained' sx={{color:'#FFFAFA',backgroundColor:'#1E1A1A ',borderColor:'#0480AB '}}>MALL</Button></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Button variant='contained' sx={{color:'#FFFAFA',backgroundColor:'#1E1A1A ',borderColor:'#0480AB '}}>THEATRE</Button></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Button variant='contained' sx={{color:'#FFFAFA',backgroundColor:'#1E1A1A ',borderColor:'#0480AB '}}>THEME PARK</Button></Typography>
              </div>
            </div>
            <div style={{display: 'flex',
                  flexWrap: 'wrap',
                ...
                <Box 
                    component="img"
                      sx={{
                        ...
                        alt="Fun Zone"
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Button variant='contained' sx={{color:'#FFFAFA',backgroundColor:'#1E1A1A ',borderColor:'#0480AB '}}>FUN ZONE</Button></Typography>
              </div>
              <div style={{flex: '10%', padding: '0 4px'}}>
                <Box 
                    component="img"
                ...
                />   
                <Typography style={{marginRight:'10px',marginBottom:'10px',padding:'0px'}}><Button variant='contained' sx={{color:'#FFFAFA',backgroundColor:'#1E1A1A ',borderColor:'#0480AB '}}>ADVENTURE</Button></Typography>
              </div>
            </div>
          </Paper>
        </Grid>

...
export default class Accomodation extends Component {
    ...
    buttonstyle={color:'#F5F3E1',backgroundColor:'#F2720D ',borderColor:'#0480AB'}
  render() {
    return (
            ...
            <Paper variant='outlined' style={{width:'1200px',height:'660px', borderRadius:'20px' ,opacity:'0.85'}}>
              <div style={{display: 'flex',flexWrap: 'wrap',padding: '0px 4px'}}>
                <div style={this.divstyle}>
                  ...
                  />   
                  <br/>
                  <Button variant="contained" sx={this.buttonstyle}> CAMPER VAN STAY</Button>
                  {/* <Typography style={this.typostyle}><h2>CAMPER VAN STAY</h2></Typography> */}
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />  
                  <br/>
                  <Button variant="contained" sx={this.buttonstyle}> RESORT STAY</Button> 
                  {/* <Typography style={this.typostyle}><h2>RESORT STAY</h2></Typography> */}
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />   
                  <br/>
                  <Button variant="contained" sx={this.buttonstyle}>BOAT HOUSE STAY</Button>
                  {/* <Typography style={this.typostyle}><h2>BOAT HOUSE STAY</h2></Typography> */}
                </div>
              </div>
              <div style={{display: 'flex',
                ...
                <div style={this.divstyle}>
                  ...
                  />  
                  <br/>
                  <Button variant="contained" sx={this.buttonstyle}>COTTAGE STAY</Button> 
                  {/* <Typography style={this.typostyle}><h2>COTTAGE STAY</h2></Typography> */}
                </div>
                <div style={this.divstyle}>
                  <Box 
                      component="img"
                  ...
                  />   
                  <br/>
                  <Button variant="contained" sx={this.buttonstyle}>HOTEL STAY</Button>
                  {/* <Typography style={this.typostyle}><h2>HOTEL STAY</h2></Typography> */}
                </div>
              </div>
            </Paper>
          </Grid>
